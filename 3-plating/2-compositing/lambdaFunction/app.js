 ...
 */
 ...
 exports.handler = async (event) => {
   ...
   const x = (background.bitmap.width/2) - (foreground.bitmap.width/2) - 125 // updated code here to center photo on background
   let composited = await background.composite(foreground, x, 230, { mode: Jimp.BLEND_SOURCE_OVER })
